...
struct Section {
    ...
    static func create(_ sectionCount: Int, sectionSerial: Int, slokasCount: Int, slokaNumber: String, content: String, meaning: String, speaker: String?) -> Section {
...
extension Section: JSONDeserializable {
    static func deserialize(_ json: JSON) -> Section {
...
extension Section {
    static func getIndexForSectionInChapter(_ section: Section, chapter: Chapter) -> Int? {
        var index: Int?
        for (i, value) in chapter.sections.enumerated() {
